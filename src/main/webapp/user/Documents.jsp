...
display: inline-block;
    ...
    border-radius: 0.25rem;"><c:if test="${CARTKEY != null}">${CARTKEY.size()}</c:if>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <c:forEach var="item" items="${requestScope.listDocument}">
                            ...
                            <div class="card d-block car-hover">
                                ...
                                <div>
                                    <div class="card-body position-relative">
                                        ...
                                        <!-- project progress-->
                                        <a href="<c:out value="${item.documentLink}"/>" target="_blank" class="btn btn-success col-12"><i
                                                class="uil-book-reader"></i> Read</a>
                                    </div> <!-- end card-body-->
                                </div>
                            </div> <!-- end card-->
                        </div>
